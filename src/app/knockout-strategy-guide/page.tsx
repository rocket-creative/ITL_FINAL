...
const heroData = {
  ...
  intro: "Since 1998, ingenious targeting laboratory has helped researchers design over 2,800 custom gene targeting projects. Our scientific consultants work with investigators at every career stage to identify the optimal knockout approach for their specific research questions, ensuring that model design aligns with experimental goals.",
      ...
      <main id="main-content">
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="knockout-strategy-guide" utmMedium="page-hero" flush />
          </div>
        </section>
        ...
        <section style={{ backgroundColor: '#008080', padding: '60px 20px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <CatalogCustomDualCta slug="knockout-strategy-guide" utmMedium="page-closing" flush />
          </div>
        </section>
