    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section style={{ backgroundColor: '#f5f5f4', padding: '40px 20px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <CatalogCustomDualCta slug="lupus-mouse-models" utmMedium="page-hero" flush />
          </div>
        </section>
        ...
        <section style={{ backgroundColor: '#0a253c', padding: '60px 20px' }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <div className="animate-in grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <section style={{ backgroundColor: '#f5f5f4', padding: '60px 20px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <CatalogCustomDualCta slug="lupus-mouse-models" utmMedium="page-closing" flush />
          </div>
        </section>
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'Lupus Mouse Models', path: '/lupus-mouse-models' },
        ]}
      />
      <script
