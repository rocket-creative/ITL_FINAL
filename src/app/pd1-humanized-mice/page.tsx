...
const publicationsData = {
  ...
  publications: getPublicationsForPageAsCitations('/pd1-humanized-mice')
};
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main ref={animatedElementsRef}>
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="pd1-humanized-mice" utmMedium="page-hero" flush />
          </div>
        </section>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildFAQSchema('/pd1-humanized-mice', faqData)),
        }}
      />
    </div>
  );
