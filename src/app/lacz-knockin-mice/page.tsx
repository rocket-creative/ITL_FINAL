    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="lacz-knockin-mice" utmMedium="page-hero" flush />
          </div>
        </section>
        ...
        <section style={{ backgroundColor: '#008080', padding: '60px 20px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <CatalogCustomDualCta slug="lacz-knockin-mice" utmMedium="page-closing" flush />
          </div>
        </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildFAQSchema('/lacz-knockin-mice', faqData))
        }}
      />
      </main>
