...
export default function RequestQuoteThankYouPage() {
  useEffect(() => {
    runThankYouConversionOnce(THANK_YOU_SESSION_QUOTE, () => {
      ...
      <main id="main-content">
        ...
        >
          ...
          <div style={{ maxWidth: '900px', margin: '0 auto', position: 'relative' }}>
            ...
            >
              Your request was submitted successfully. A scientific consultant will contact you within
              one business day with pricing and next steps.
            </p>
          </div>
        </section>
        ...
        <section style={{ backgroundColor: '#008080', padding: '48px 20px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            >
              While you wait, you can book a call or browse technical resources.
            </p>
