  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section className="page-hero" style={{
          ...
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            <div style={{
              ...
              <span style={{ color: '#ffffff', fontSize: '.85rem', fontWeight: 500 }}>Catalog Models</span>
            </div>
            <h1 style={{
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="single-checkpoint-mice" utmMedium="page-hero" flush />
          </div>
        </section>
      ...
      <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '3rem', paddingBottom: '3rem' }}>
        <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
          <CatalogCustomDualCta slug="single-checkpoint-mice" utmMedium="page-closing" flush />
        </div>
      </section>
