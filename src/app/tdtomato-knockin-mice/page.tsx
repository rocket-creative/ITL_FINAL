    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="tdtomato-knockin-mice" utmMedium="page-hero" flush />
          </div>
        </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildFAQSchema('/tdtomato-knockin-mice', faqData))
        }}
      />
      </main>
      ...
      <StandardPageCtaStack
        ...
        labSignalsTitle="Stay Updated on Reporter Knockin Technologies"
        labSignalsDescription="Get the latest insights on tdTomato models, fluorescent reporters, and advanced imaging techniques."
      />
      <UXUIDCFooter />
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'tdTomato Knockin Mice', path: '/tdtomato-knockin-mice' },
        ]}
      />
    </div>
  );
