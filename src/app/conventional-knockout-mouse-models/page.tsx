...
const heroData = {
  ...
  intro: "Since 1998, ingenious targeting laboratory has generated over 2,800 custom mouse models, including conventional knockouts - providing researchers with definitive loss of function tools for understanding gene function across every major therapeutic area.",
    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section style={{ backgroundColor: '#f5f5f4', padding: '40px 20px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <CatalogCustomDualCta slug="conventional-knockout-mouse-models" utmMedium="page-hero" flush />
          </div>
        </section>
        ...
        <section style={{ backgroundColor: '#f5f5f4', padding: '60px 20px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <CatalogCustomDualCta slug="conventional-knockout-mouse-models" utmMedium="page-closing" flush />
          </div>
        </section>
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'Conventional Knockout Mouse Models', path: '/conventional-knockout-mouse-models' },
        ]}
      />
      <script
