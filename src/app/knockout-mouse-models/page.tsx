...
const heroData = {
  ...
  intro: 'Since 1998, ingenious targeting laboratory has completed over 2,800 mouse model generation projects for researchers at universities, pharmaceutical companies, and research institutions worldwide. Our knockout mouse models have supported research published in more than 800 peer reviewed articles, including in Science, Nature, and Cell.',
...
const publicationsData = {
  ...
  publications: getPublicationsForPage('/knockout-mouse-models'),
};
      ...
      <main id="main-content">
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="knockout-mouse-models" utmMedium="page-hero" flush />
          </div>
        </section>
