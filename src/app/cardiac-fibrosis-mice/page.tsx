...
const heroData = {
  ...
  intro: "Since 1998, ingenious targeting laboratory has supported cardiovascular research with mouse model generation for studying cardiac fibrosis, myocardial remodeling, and heart failure.",
    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="cardiac-fibrosis-mice" utmMedium="page-hero" flush />
          </div>
        </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildFAQSchema('/cardiac-fibrosis-mice', faqData))
        }}
      />
      </main>
      ...
      <StandardPageCtaStack
        ...
        labSignalsTitle="Stay Updated on Cardiac Fibrosis Research"
        labSignalsDescription="Get the latest insights on myocardial remodeling, fibroblast biology, and anti-fibrotic therapeutics."
      />
      <UXUIDCFooter />
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'Cardiac Fibrosis Mice', path: '/cardiac-fibrosis-mice' },
        ]}
      />
    </div>
  );
