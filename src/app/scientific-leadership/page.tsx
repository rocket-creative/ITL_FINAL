            ...
            {[
              {
                ...
                description: 'Homologous recombination expertise spanning conventional knockouts, conditional alleles, point mutations, and complex humanization strategies. Over 2,800 successful generated targeting events since 1998.',
              },
              {
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center', padding: '20px' }}>
              ...
              <p style={{ color: '#666', fontSize: '1rem' }}>
                Mouse Model Generation Generated
              </p>
            </div>
