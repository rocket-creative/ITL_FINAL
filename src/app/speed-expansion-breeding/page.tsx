  ...
  const heroRef = useRef<HTMLDivElement>(null);  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
            ...
            <div className="grid grid-cols-1 gap-12 items-center">
              <div>
                ...
                <div className="hero-animate flex flex-wrap gap-4">
                  <Link
                    href="/cohort-consultation/?ref=speed-expansion-hero#request-form"
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="speed-expansion-breeding" utmMedium="page-hero" flush />
          </div>
        </section>
      ...
      <StandardPageCtaStack
        ...
        labSignalsTitle="Speed Expansion Breeding Insights"
      />
      <UXUIDCFooter />
