    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="inflammatory-disease-mice" utmMedium="page-hero" flush />
          </div>
        </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildFAQSchema('/inflammatory-disease-mice', faqData))
        }}
      />
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'Inflammatory Disease Mice', path: '/inflammatory-disease-mice' },
        ]}
      />
    </div>
  );
