    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section style={{ backgroundColor: '#f5f5f4', padding: '40px 20px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <CatalogCustomDualCta slug="epilepsy-mouse-models" utmMedium="page-hero" flush />
          </div>
        </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildFAQSchema('/epilepsy-mouse-models', faqData))
        }}
      />
      </main>
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'Epilepsy Mouse Models', path: '/epilepsy-mouse-models' },
        ]}
      />
    </div>
  );
