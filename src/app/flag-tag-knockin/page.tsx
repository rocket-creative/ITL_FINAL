  ...
  const heroRef = useRef<HTMLDivElement>(null);  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="flag-tag-knockin" utmMedium="page-hero" flush />
          </div>
        </section>
      ...
      <StandardPageCtaStack
        ...
        labSignalsTitle="Stay Updated on Epitope Tag Technologies"
        labSignalsDescription="Get the latest insights on FLAG tag knockins, protein detection methods, and immunoprecipitation strategies."
      />
      <UXUIDCFooter />
