      ...
      <main id="main-content">
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="tag-knockin-mice" utmMedium="page-hero" flush />
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {tagPlacementData.map((placement, index) => (
                ...
                >
                  ...
                  {placement.note && (
                    <p style={{ color: '#666', fontSize: '.85rem', fontStyle: 'italic', marginTop: '10px' }}>
                      {placement.note}
                    </p>
                  )}
                </div>
        ...
        <section style={{ backgroundColor: '#f5f5f4', padding: '60px 20px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <CatalogCustomDualCta slug="tag-knockin-mice" utmMedium="page-closing" flush />
          </div>
        </section>
