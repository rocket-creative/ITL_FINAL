        ...
        <section ref={heroRef} style={{ background: 'linear-gradient(135deg, #0a253c 0%, #1a4a6e 50%, #008080 100%)', padding: '80px 20px 60px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div className="hero-animate flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
              <Link href="/request-quote" className="inline-flex items-center gap-2 transition-all duration-300 hover:-translate-y-1 px-4 sm:px-5" style={{ backgroundColor: 'white', color: '#0a253c', padding: '10px 16px', fontSize: '.85rem', fontWeight: 500 }}><span>Request a Quote</span><span>→</span></Link>
