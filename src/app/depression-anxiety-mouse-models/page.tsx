    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildFAQSchema('/depression-anxiety-mouse-models', faqData))
        }}
      />
      </main>
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'Depression Anxiety Mouse Models', path: '/depression-anxiety-mouse-models' },
        ]}
      />
    </div>
  );
