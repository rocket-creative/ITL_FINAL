...
const publications = getPublicationsForPage('/tissue-specific-knockout');
      ...
      <main id="main-content">
        ...
        <section className="px-5" style={{ backgroundColor: '#f5f5f4', paddingTop: '2.5rem', paddingBottom: '2.5rem' }}>
          <div className="mx-auto w-full" style={{ maxWidth: '1100px' }}>
            <CatalogCustomDualCta slug="tissue-specific-knockout" utmMedium="page-hero" flush />
          </div>
        </section>
        ...
        <section style={{ backgroundColor: '#f5f5f4', padding: '60px 20px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <CatalogCustomDualCta slug="tissue-specific-knockout" utmMedium="page-closing" flush />
          </div>
        </section>
