    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main id="main-content">
        ...
        <section style={{ backgroundColor: '#f5f5f4', padding: '40px 20px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <CatalogCustomDualCta slug="nash-mash-mouse-models" utmMedium="page-hero" flush />
          </div>
        </section>
        ...
        <section style={{ backgroundColor: '#f5f5f4', padding: '60px 20px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <CatalogCustomDualCta slug="nash-mash-mouse-models" utmMedium="page-closing" flush />
          </div>
        </section>
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: 'NASH MASH Mouse Models', path: '/nash-mash-mouse-models' },
        ]}
      />
      <script
