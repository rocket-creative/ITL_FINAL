---
legacy_url: "https://www.genetargeting.com/fast-mice"
new_build_url: "/fast-mice/"
url_handling: "reuse"
link_from: ["/custom-mouse-models/", "/knockin-mouse-models/"]
extracted_date: "2026-01-11"
title: "F.A.S.T.™ Technology - Inducible/Reversible Mouse Models"
---

# F.A.S.T Technology

## Inducible/Reversible F.A.S.T.™ Technology

The F.A.S.T.™ (Flexible Accelerated STOP TetO) technology by ingenious targeting laboratory offers researchers a versatile and powerful tool for generating multi-purpose mouse lines with controllable functionalities, all from a single targeting event.

Demonstrated in Science¹, this technology allows for five or more controllable functionalities from the same locus, simply through mating², streamlining the mouse model generation process.
...
As a knockout first, the Mlc1 gene function was rescued by mating the initial mouse line to a tissue specific Cre line of choice. Alternatively, gene expression can be induced through the F.A.S.T.™ cassette.

- **Ectopic Gene Expression:** A tetracycline transactivator (tTA) line was used to produce an ectopic gene expression model
- **Tissue-Specific Over-Expression:** The tTA line also enabled tissue-specific over-expression models
- **Conditional Knockdown/Knockout:** A tetracycline trans-silencer line was used to generate a tissue-specific conditional knockdown/knockout
